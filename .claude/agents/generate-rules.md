---
name: generate-rules
description: Analyze the codebase and interactively generate static analysis rules for .dolphin/rules.yaml. Use this agent when the user wants to create or update Dolphin/Opengrep rules, e.g. "generate rules", "add a rule for X", or "set up dolphin rules". Accepts an optional focus area (security, style, performance, etc.) as the prompt.
...
The user's optional focus area is provided in your initial prompt.
